        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
            ...
            <div className="p-4 rounded-xl bg-slate-50/70 border border-slate-100 lg:bg-transparent lg:border-none lg:p-0">
              ...
              <p className="text-[11px] sm:text-xs text-slate-400 mt-0.5">{isAr ? 'سلسلة تبريد معتمدة HACCP' : 'HACCP cold chain guarantee'}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            <div className="lg:col-span-6 space-y-4 sm:space-y-6">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-[#0B2545] tracking-tight font-cinzel leading-tight">
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200">
                ...
                <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 text-white">
                  ...
                  <h3 className="text-lg sm:text-xl font-bold font-cinzel mt-1">
