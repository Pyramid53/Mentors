    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-white rounded-2xl overflow-hidden shadow-2xl border border-slate-200 max-h-[90vh] flex flex-col font-sans">
        ...
        <div className="relative h-48 bg-slate-900 overflow-hidden shrink-0">
          ...
          <button
            onClick={onClose}
            className={`absolute top-4 ${isAr ? 'left-4' : 'right-4'} bg-black/40 hover:bg-black/60 text-white p-1.5 rounded-full transition-colors z-10`}
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <div className="absolute bottom-4 left-6 right-6">
            ...
            <h3 className="text-2xl font-bold text-white tracking-tight font-cinzel">
